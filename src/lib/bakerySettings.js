...
export function normalizedBakerySettings(value = {}) {
  ...
  return {
    ...
    allowGuestCheckout: Boolean(settings.allowGuestCheckout),
    requireSignInForOrders: Boolean(settings.requireSignInForOrders),
    ...
    customerReorderEnabled: Boolean(settings.customerReorderEnabled),
    customerProfileSavingEnabled: Boolean(settings.customerProfileSavingEnabled),
